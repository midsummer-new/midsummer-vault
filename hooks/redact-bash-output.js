...
/**
 * PostToolUse hook for Bash: 5-layer secret detection and redaction.
 *
 ...
 * Does NOT store detected secrets — bash hook is output-only.
 */
...
function log(msg) {
  try { fs.appendFileSync(LOG, '[' + new Date().toISOString() + '] [bash] ' + msg + '\n'); } catch {}
}
